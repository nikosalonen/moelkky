  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
      ...
      <div className="text-center mb-8">
        ...
        <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4 mb-6 max-w-md mx-auto">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{winner.penalties}</div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className={`font-semibold ${isWinner ? "text-green-700" : "text-gray-800"}`}>
                        {player.name}
                        {isWinner && (
                  ...
                  <div className={`text-2xl font-bold ${isWinner ? "text-green-600" : "text-gray-700"}`}>
                    {player.score}
                  </div>
                </div>
              </div>
      ...
      <div className="text-center">
        <button
          onClick={onNewGame}
          className="px-8 py-3 bg-green-500 text-white text-lg font-semibold rounded-lg hover:bg-green-600 transition-colors duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
        >
          🎮 Start New Game
        </button>
